<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('monitor_car')">导出</a-button>
          ...
          },
          {
            ...
            customRender:(text)=>{
              if(!text){
                ...
                return filterMultiDictText(this.dictOptions['carType'], text+"")
              }
            }
          },
          {
