  ...
  export default {
    ...
    methods: {
      ...
      edit (record) {
        ...
        this.visible = true;
        this.$nextTick(() => {
          this.form.setFieldsValue(pick(this.model,'personName','personIdCard','outInType','outInTime','personType','photoUrl','address','deviceCode'))
        })
      },
      close () {
        this.$emit('close');
      ...
      popupCallback(row){
        this.form.setFieldsValue(pick(row,'personName','personIdCard','outInType','outInTime','personType','photoUrl','address','deviceCode'))
      },
